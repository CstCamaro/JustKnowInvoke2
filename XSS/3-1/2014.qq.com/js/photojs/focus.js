...
function initFoucs(){
				...
				$('#focus').css({width:kuandu});
				$(".focusBtnL2").css({width:kuan/2});
				$(".focusBtnL2").css({left:-kuan/2});
				$(".focusBtnR2").css({width:kuan/2});
				$(".focusBtnR2").css({right:-kuan/2});
					var picArr = $('#focusImgs'), tit = $('#foucsTit'), titHtml = tit.html();
					var li = $('#focusImgs li'), len = li.length;
				...
				var html = LI(final) +  $('#focusImgs').html() + LI(one);
					picArr.html(html);
				tit.html(tit.html() + '<span></span> <span style="display:none"></span>');
					$('#foucsTit span').eq(0).hide();
				}
//焦点图		 
Focus = function(args) {
...
/*  |xGv00|565f2234474dd4aa5aec4f2361bb4d75 */