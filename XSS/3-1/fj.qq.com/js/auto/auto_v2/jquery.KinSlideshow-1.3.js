(function($) {
    $.fn.KinSlideshow = function(settings) {
        settings = jQuery.extend({
            ...
            isHasCtrl: true,
            ctrl: {
                ctrl_link: '//mat1.gtimg.com/cq/cody/2013/auto/all/icon.png',
                ctrl_top: 33,
                ctrl_left: 0,
                ctrl_right: 0,
                ctrl_width: 35,
        ...
        function KSS_start() {
            ...
            $(ksbs + " a img").each(function(i) {
                KSS_DateArray.push("<a href=\"" + $(this).parent().attr("href") + "\" style=\"color:#414141;text-decoration:none;\" target=\"_blank\">" + $(this).attr("alt") + "</a>");
            });
            ...
            if (settings.isHasBtn && KSS_imgaeLength >= 2) {
                ...
                if (settings.isHasCtrl) {
                    ...
                    $(ksbs + " a.ctrl-L").hover(function() {
                        $(this).css({ 'background-position': "0 -144px", left: 0 })
                    }, function() {
                        $(this).css({ 'background-position': "0 -88px", left: 0 })
                    })
                    $(ksbs + " a.ctrl-R").css({
                    ...
                    $(ksbs + " a.ctrl-R").hover(function() {
                        $(this).css({ 'background-position': "0 -256px", right: 0 })
                    }, function() {
                        $(this).css({ 'background-position': "0 -200px", right: 0 })
                    })
                }
            };
        };
        ...
        function KSS_mousehover() {
            ...
            $(ksbs + " #KSS_XposBox img").mouseover(function() {
                clearInterval(KSS_setInterval);
            });
            $(ksbs + " #KSS_XposBox img").mouseout(function() {
                KSS_setInterval = setInterval(function() {
                    KSS_move(settings.moveStyle)
                },
				KSS_IntervalTime * 1000 + settings.moveSpeedTime);
...
})(jQuery); /*  |xGv00|839b23327318bdcf501aa59572327c5d */