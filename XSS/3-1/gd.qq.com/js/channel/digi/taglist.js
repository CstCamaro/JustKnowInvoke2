String.prototype.realLength = function(){
    ...
    Common.Page = function(config){
        ...
        this.htmlEl     = $('<div class="page pageArea" ><span class="na">上一页</span><span class="na">下一页</span></div>');
    ...
    Common.Page.prototype.buildPage = function(num,totalPage){
        ...
        var prevpageEl = '<span><a href="javascript:void(0)" class="f12 goprev">上一页</a></span>';
        var nextpageEl = '<span><a href="javascript:void(0)" class="f12 gonext">下一页</a></span>';
        ...
        var pageitemEl = '';
        if(num == 1){
            prevpageEl = '<span class="Disabled">上一页</span>';                          
        }
        if(num >= totalnum){
            nextpageEl = '<span class="Disabled">下一页</span>';
        }
        if(totalnum<=6){
            beginnum = 1;
            endnum = totalnum+1;
            ...
            if(num<4){      
                endnum = 6;
                endEl = '<span class="ellipsis">...</span><span><a href="javascript:void(0)" class="goto" num='+totalnum+'>'+totalnum+'</a></span>';         
                }else if(num>totalnum-3){           
                beginnum = totalnum-4;
                beginEl = '<span><a href="javascript:void(0)" class="goto" num=1>1</a></span><span class="ellipsis">...</span>';                     
            }
            else{
                beginnum = num-2;
                endnum = num+3;
        ...
        for(var i=beginnum; i<endnum; i++){
            if(i == num) pageitemEl += '<span class="isNow" title="您正在浏览本页">'+i+'</span>';
            else pageitemEl += '<span><a href="javascript:void(0)" class="goto" num=' + i + '>' + i + '</a></span>';
        }
    ...
    */
    var ArticleList = function(listWrap,requireURL){
        ...
        this.PAGES_WRAP     = $('.neirong_page',$(listWrap));
        ...
        this.LIST_HTML         = '<div class="nrC">{imgarea}<h3 class="mxzxItem "><a target="_blank" class="newsTit" href="{url}">{stitle}</a></h3><p class="newsInfo">{date} {time}<span class="date"></span></p><div class="nrP"><span>{desc}</span> <a target="_blank" href="{url}">继续阅读</a></div><div class="aTools"><a class="aCom" target="_blank" href="{url}"></a><!--<i><a class="aRet" target="_blank"></a></i>--></div><div class="tags">{tags}</div></div>';
    }
    ...
    ArticleList.prototype.fillData = function(itemObj,listHTML,i){
        ...
        switch (r)
        {
            ...
            return time;
            case 'imgarea':
            return itemObj.image?('<a href="'+itemObj.url+'" class="nrPic" target="_blank"><img onerror="this.src=\'//mat1.gtimg.com/news/imgcss_article_qq/def_article_pic.jpg\'" src="'+itemObj.image.replace(/small.jpg/,"small4.jpg")+'" width="199" alt="'+title+'" /></a>'):'';
            case 'tags':
...
}/*  |xGv00|c69d8f9d79e53928251f3d386d1901df */