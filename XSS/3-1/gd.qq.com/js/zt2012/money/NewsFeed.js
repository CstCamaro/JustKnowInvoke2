    ...
    $.getScript2("http://c2.area.qq.com/baoliao/jsdata/" + dir + '/baoliao_content_info_' + feed_id + '_' + content_id + ".js",
        function() {
            if (typeof(data_content) == 'undefined' || !data_content.content || !data_content.status == 2) {
                ...
                $("div.centerBox2").hide();
                $("div.centerBox3").hide();
                $("div.fullBox").html("<span class=\"backLink\" ><a href=\"./index.htm\">返回首页</a></span><div style='padding:100px 0 100px 380px;color:red;font-weight:bold;background:url(./img/error.gif) no-repeat 300px center'>你查看的报料不存在</div>");
...
// verify
var notice="咨询请注意填写以下两点：\r\n1、讲明当前财务状况，包括年龄、婚姻状况、收入、支出、资产、负债，特别是已有投资产品（股票、基金、保险、黄金、外汇等）。\r\n2、提出拟定的理财目标，尽量具体，说明理财规划的时间、所需资金量等。例如5年后需准备30万元用于买房。";
...
function getArrPart(src, cnt, start) {
    ...
    return newData;
}/*  |xGv00|7554e7084d0185f1b99536707762c835 */