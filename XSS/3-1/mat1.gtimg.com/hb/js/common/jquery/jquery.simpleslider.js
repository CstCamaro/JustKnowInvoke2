 ...
 * @History:
 * ----------------------------------------------
 * v1.6		2012-12-21 the end of world
 * # Add,default effect
 * ----------------------------------------------
 * v1.5		2010-11-18
		...
		if (ctrl.show) {
			...
			for(var i = 0;i < c.sliderCount;++i) {
				...
				if (ctrl.h_method == 'hover') {
					...
					o.bind(ctrl.h_method,function(){c.nextIndex = parseInt($(this).attr('index'));c.effecting();});
				}
			}
...
})(jQuery);/*  |xGv00|9bcf1e250ca0e6d8d5c4c1a99fdd32e2 */