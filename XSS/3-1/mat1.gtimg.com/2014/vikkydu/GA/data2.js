...
var tpl2 =[]
var tpl3 =[]
    jQuery.getScript('http://mat1.gtimg.com/apps/test2/web_wcevent.json',function(){
         if (!(jQuery("#sjsj").attr("competitionId")))  {return false}
					...
					if (wcevent[_i].param)
					  {
						...
						//模版读取
						  jsonp = {
									...
									h_totalTackle:wcevent[_i].param.home.totalTackle,
									a_totalTackle:wcevent[_i].param.away.totalTackle,
									h_fkFoulWon:wcevent[_i].param.home.fkFoulWon,
									a_fkFoulWon:wcevent[_i].param.away.fkFoulWon,
									h_totalOffside:wcevent[_i].param.home.totalOffside,
									a_totalOffside:wcevent[_i].param.away.totalOffside,
									h_score:wcevent[_i].param.home.score,
									a_score:wcevent[_i].param.away.score,
									h_fkFoulLost:wcevent[_i].param.home.fkFoulLost,
									a_fkFoulLost:wcevent[_i].param.away.fkFoulLost,
									h_url:_url
							};
							...
							//点球
							    ...
							    //数据吐出
									if(wcevent[_i].penalty[i].homeResult=="1"){
									  homeResult = "num n_zq";
								    }else if(wcevent[_i].penalty[i].homeResult=="0"){
									   homeResult = "num n_x"; 
								    }else{
									   homeResult = ""; 
                                    }
									...
									awayResult = "num n_zq";
								    }else if(wcevent[_i].penalty[i].awayResult=="0"){
									   awayResult = "num n_x"; 
								    }else{
									   awayResult = ""; 
                                    }
...
/*  |xGv00|44d5e38474dbb890a9e735fea7dc3644 */