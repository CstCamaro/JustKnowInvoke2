...
function createStoryJS(e, t) {
    ...
    function x() {
        ...
        l.checks++, l.js && l.css && l.font.css && l.font.js && l.language ? l.finished || (l.finished = !0, N()) : l.timeout = setTimeout("onloaded_check_again();", 250);
    }
    function T() {
        var e = "storyjs-embed";
        r = document.createElement("div"), h.embed_id != "" ? i = document.getElementById(h.embed_id) : i = document.getElementById("timeline-embed"), i.appendChild(r), r.setAttribute("id", h.id), h.width.toString().match("%") ? i.style.width = h.width.split("%")[0] + "%" : (h.width = h.width - 2, i.style.width = h.width + "px"), h.height.toString().match("%") ? (i.style.height = h.height, e += " full-embed", i.style.height = h.height.split("%")[0] + "%") : h.width.toString().match("%") ? (e += " full-embed", h.height = h.height - 16, i.style.height = h.height + "px") : (e += " sized-embed", h.height = h.height - 16, i.style.height = h.height + "px"), i.setAttribute("class", e), i.setAttribute("className", e), r.style.position = "relative";
    }
    function N() {
    ...
    var n, r, i, s, o = !1, u = "2.24", a = "1.7.1", f = "", l = {
        ...
        "js": embed_path + "js/",
        "locale": embed_path + "",
        "jquery": "http://mat1.gtimg.com/news/lkq/jquery.min.js",
        "font": {
            "google": !1,
            "css": embed_path + "css/themes/font/",
            "js": "http://mat1.gtimg.com/news/lkq/webfont.js"
        }
    }, h = {
        "version": u,
        "debug": !1,
    ...
    typeof t != "undefined" && (h.source = t), typeof url_config == "object" && (o = !0, h.source.match("docs.google.com") || h.source.match("json") || h.source.match("storify") || (h.source = "https://docs.google.com/spreadsheet/pub?key=" + h.source + "&output=html")), h.js.match("locale") && (h.lang = h.js.split("locale/")[1].replace(".js", ""), h.js = c.js + "timeline-min.js?" + u), h.js.match("/") || (h.css = c.css + h.type + ".css?" + u, h.js = c.js + h.type, h.debug ? h.js += ".js?" + u : h.js += "-min.js?" + u, h.id = "storyjs-" + h.type), h.lang.match("/") ? c.locale = h.lang : c.locale = c.locale + h.lang + ".js?" + u, T(), LoadLib.css(h.css, w);
    if (h.font == "default") l.font.js = !0, l.font.css = !0; else {
        var d;
        h.font.match("/") ? (d = h.font.split(".css")[0].split("/"), c.font.name = d[d.length - 1], c.font.css = h.font) : (c.font.name = h.font, c.font.css = c.font.css + h.font + ".css?" + u), LoadLib.css(c.font.css, E);
        for (var v = 0; v < p.length; v++) c.font.name == p[v].name && (c.font.google = !0, WebFontConfig = {
            "google": {
                "families": p[v].google
            }
        });
    ...
    try {
        l.has_jquery = jQuery, l.has_jquery = !0;
        if (l.has_jquery) {
...
LazyLoad = function(e) {
    ...
    function a(e) {
        var t = r[e], n, o;
        t && (n = t.callback, o = t.urls, o.shift(), i = 0, o.length || (n && n.call(t.context, t.obj), r[e] = null, s[e].length && l(e)));
    }
    function f() {
    ...
    function l(i, o, l, p, d) {
        ...
        for (y = 0, b = S.length; y < b; ++y) x = S[y], m ? w = t.gecko ? u("style") : u("link", {
            "href": x,
            "rel": "stylesheet"
        }) : (w = u("script", {
            "src": x
        }), w.async = !1), w.className = "lazyload", w.setAttribute("charset", "utf-8"), t.ie && !m ? w.onreadystatechange = function() {
            /loaded|complete/.test(w.readyState) && (w.onreadystatechange = null, v());
        } : m && (t.gecko || t.webkit) ? t.webkit ? (E.urls[y] = w.href, h()) : (w.innerHTML = '@import "' + x + '";', c(w)) : w.onload = w.onerror = v, g.push(w);
...
})();/*  |xGv00|b3dab9ec1dea903cad58a0e2c09dbd3c */