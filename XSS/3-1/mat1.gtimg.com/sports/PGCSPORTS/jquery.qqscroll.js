...
(function($){
    ...
    $.fn.qqScroll = function (options){
        ...
        var opts = $.extend({}, $.qqScroll.defaults, options),
            ...
            scroller.controll = obj.find(opts.controll);
        ...
        scroller.fn = {
            ...
            init: function(){
				...
				scroller.controll.click(function() {//控制滚动
					var flag = scroller.controll.attr("flag");
                	if( flag == "false"){
	                	opts.auto = true;
	                	scroller.controll.attr("flag","true");
	                	scroller.controll.text("关闭滑动");
	                	scroller.fn.addControl();
                		scroller.fn.start();
	                	return flag;
                	}
	                	...
	                	opts.auto = false;
	                	scroller.controll.attr("flag","false");
	                	scroller.controll.text("开启滑动");
	                	scroller.fn.addControl();
                		scroller.fn.start();
	                	return flag;
                	}
...
/*  |xGv00|5b4e8879b592a2ab8f21de6fa8493f9d */