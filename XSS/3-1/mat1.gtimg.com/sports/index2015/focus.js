...
(function($){
    ...
    $.fn.qqfocus = function(options){
        ...
        focuser.fn = {
                ...
                switch (opts.effect) {
                    case 'scrollx':
                        ...
                        if(opts.isSeamless && focuser.leftside == true){
                            ...
                            focuser.conbox.stop().animate({left:focuser.conitem.width() + 'px'}, opts.speed,function(){
                        ...
                        if(opts.isSeamless && focuser.rightside == true){
                            ...
                            focuser.conbox.stop().animate({left:-focuser.conitem.length * focuser.conitem.width() + 'px'}, opts.speed,function(){
            ...
            prev: function () {
                focuser.index = focuser.index < 2 ? (focuser.leftside = true,(focuser.conitem.length - focuser.index)) : focuser.index - 2;
                focuser.fn.stop();
                focuser.fn.slide();
                focuser.fn.play();
            },
...
})(jQuery);/*  |xGv00|f4ec4e9c6b3eeb99f9039a37f59bed2b */