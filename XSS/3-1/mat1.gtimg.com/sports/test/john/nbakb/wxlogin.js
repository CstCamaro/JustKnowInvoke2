...
$(function(){
    ...
    var namespace = "wxlogin";// 全局变量名

    // 登录 iframe 地址 TODO: 切换调试地址为正式地址
    ...
    */
    ...
    var getUserInfo = function(callback) {
        ...
        if ("qq" === login_method) {
            ...
            // QQ登录回调
            if ("function" === typeof window.forURecommendReqSubData) window.forURecommendReqSubData();//为你推荐模块
            if ("function" === typeof window.checkSubscribe) window.checkSubscribe();// 赛程表模块
    ...
    // 登录成功回调
    window.wxlogin.loginSuccess = function(obj) {
    ...
    var openLoginWin = function() {
        ...
        // 设置关闭功能
        window.wxlogin.closeLoginWin = function() {
            $loginWindow.remove();
        ...
        getUserInfo(function(data) {
            ...
            var vipStatusReady = function(tyvip, tykb) {
                ...
                $avatar.html(function(){
                    ...
                    html += '<div class="bubble"><div class="inner">';
    ...
    // 其他暴露
    window.wxlogin.openLogin = openLoginWin;
    window.wxlogin.loginCheck = init;
});/*  |xGv00|3f76787203122574dda5cecf357f3ca7 */