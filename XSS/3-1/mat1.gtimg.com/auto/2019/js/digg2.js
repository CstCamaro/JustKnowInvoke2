                    ...
                    try {
                        AppPlatform.$('apps_svy_opt_title_' + projId + '_' + IndexId).innerHTML =
                           // AppPlatform.$('apps_svy_opt_title_' + projId + '_' + IndexId).getAttribute("doneText");//
							...
							'<a href="javascript:AppPlatform.Survey.Digg.digg(this, ' +	projId + ', ' +	AppPlatform.Survey.Digg.ProjectList[projId].SubjectId +	', ' + OptId + ');" target=\"_self\">' +
							AppPlatform.$('apps_svy_opt_title_' + projId + '_' + IndexId).getAttribute("doneText") + 
							'</a>';//(2014.12.26jichaojiang)
                    } catch (e) {}
                }
            }
...
}/*  |xGv00|45d6b5bd48bc9d25a8358464f71b7559 */