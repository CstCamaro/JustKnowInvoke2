        ...
        $.extend(window[jQuery.widgetName],{
        	dealerOption: function(){
	        	var _opt = {
	        		...
	        		tpl:{
						...
						priceList : '<tr>\
										<td width = "414px">\
											<div style = "width:auto;">\
												<div class = "imgContainer"><a  target="_blank" href="//wecar.qq.com/dealer/promotion/detail/id/{sdealer_id}/article_id/{sarticle_id}"><img  width="120" height="80" src = {smodel_pic} onerror = "this.src=\'//img1.gtimg.com/auto/pics/hv1/112/202/1695/110268997.png\'" bossZone = "cxtp" autobussboss="photo|onsale_model|6" onclick="registerZone2(this,1)" /></a></div>\
											<div class = "conContainer" >\
												<ul>\
													<li class = "txt_l name" bossZone = "cxmc" autobussboss="model|onsale_model|6"><a  target="_blank" href="//wecar.qq.com/dealer/promotion/detail/id/{sdealer_id}/article_id/{sarticle_id}" title = "{modelnameall}">{smodel_name}</a>\
													</li>\
													...
													<li class = "txt_l phoneLi clearfix"><em>{vip}<a href = "//wecar.qq.com/{sdealer_id}" target="_blank" autobussboss = "dealer|onsale_model|6">{sdealer_name}</a></em></li>\
													{phone400}\
												</ul>\
											</div>\
											</div>\
										...
										<td width = "86px" style = "vertical-align:inherit;">\
											<ul>\
												<li class="priceAsk"><span class="autoaskprice" onclick="registerZone2(this,1)"  bossZone = "xjrk" autobussboss="askprice|onsale_model|6" class = "txt_c"  ip = "{ip}" ip_province = "{ip_province}" ip_city = "{ip_city}" qq = "{qq}" city = "{}" source_url = "{source_url}" source_title = "{source_title}" city = "{city}" manu_id = "{smanu_id}" brand_id = "{sbrand_id}" model_id = "{smodel_id}" serial_id = "{sserial_id}" dealer_id = "{sdealer_id}" module = "lowprice_model">询问底价</span>\
												</li>\
											</ul>\
										</td>\
									</tr>',
						priceListSerialTwoLeft:'<div class = "serialCon clearfix">\
											<div class = "serialLeft">\
												<a href = "//auto.qq.com/jiangjia.htm?cityid={scity_realid}&brandid={sbrand_id}&serialid={sserial_id}" target="_blank"><img src = "{FSerialPic}" onclick = "registerZone2(this,1)" bossZone = "cxitp" autobussboss="photo|onsale_price|6"/></a><br/>\
												<span class = "serialName"><a href = "//auto.qq.com/jiangjia.htm?cityid={scity_realid}&brandid={sbrand_id}&serialid={sserial_id}" target="_blank" onclick = "registerZone2(this,1)" bossZone = "cximc" autobussboss="serial|onsale_price|6">{FName}</a></span>\
						...
						priceListSerialTwo:'<tr class = "up">\
														<td width = "245px">\
															...
															<div class = "conContainer" >\
																<ul>\
																<li class = "txt_l name" ><a  target="_blank" 	href="//wecar.qq.com/dealer/promotion/detail/id/{sdealer_id}/article_id/{sarticle_id}" onclick = "registerZone2(this,1)" bossZone = "cxcxmc" autobussboss="model|onsale_price|6" title = "{modelnameall}">{smodel_name}</a>\
																	</li>\
																	...
																	<li class = "txt_l phoneLi clearfix"><em>{vip}<a href = "//wecar.qq.com/{sdealer_id}" target="_blank" onclick = "registerZone2(this,1)" bossZone = "cxsjdp" autobussboss="dealer|onsale_price|6" >{sdealer_name}</a></em></li>\
																	{phone400}\
																</ul>\
															</div>\
															</div>\
														...
														<td width = "86px" style = "vertical-align:inherit;">\
															<ul>\
																<li class="priceAsk"><span class="autoaskprice"  onclick="registerZone2(this,1)"  bossZone = "cxxjrk" autobussboss="askprice|onsale_price|6" class = "txt_c"  ip = "{ip}" ip_province = "{ip_province}" ip_city = "{ip_city}" qq = "{qq}" city = "{}" source_url = "{source_url}" source_title = "{source_title}" city = "{city}" manu_id = "{smanu_id}" brand_id = "{sbrand_id}" model_id = "{smodel_id}" serial_id = "{sserial_id}" dealer_id = "{sdealer_id}" module = "lowprice_serial">询问底价</span>\
																</li>\
						...
						priceListSerialR:'</tbody>\
											...
											<a onclick = "registerZone2(this,1)" bossZone = "qbcx" autobussboss="match|onsale_price|6" href = "//auto.qq.com/jiangjia.htm?cityid={scity_realid}&brandid={sbrand_id}&serialid={sserial_id}" class = "all" target="_blank"></a>\
										</div>',
						priceListSerialOneLeft:'<div class = "serialConSingle clearfix">\
												<div class = "serialLeft">\
												<a href = "//auto.qq.com/jiangjia.htm?cityid={scity_realid}&brandid={sbrand_id}&serialid={sserial_id}" target="_blank"><img src = "{FSerialPic}" onclick = "registerZone2(this,1)" bossZone = "cxitp" autobussboss="photo|onsale_price|6"/></a><br/>\
												<span class = "serialName"><a href = "//auto.qq.com/price.htm?cityid={scity_realid}&brandid={sbrand_id}&serialid={sserial_id}" target="_blank" onclick = "registerZone2(this,1)" bossZone = "cximc" autobussboss="model|onsale_price|6">{FName}</a></span>\
												</div>',
													...
													<tbody id = "list">\
														<tr class = "middle">\
															<td width = "245px">\
																...
																<div class = "conContainer" >\
																	<ul>\
																		<li class = "txt_l name" onclick = "registerZone2(this,1)" bossZone = "cxcxmc" autobussboss="model|onsale_price|6"><a  target="_blank" href="//wecar.qq.com/dealer/promotion/detail/id/{sdealer_id}/article_id/{sarticle_id}" title = "{modelnameall}">{smodel_name}</a>\
																		</li>\
																		<li class = "txt_l dealer clearfix">\
																			<em><span class = "area" title = {sorder_area_str}>{sorder_area}</span><span class = "gapLine">|</span><span class = "carCount">{stock}</span></em>\
																		</li>\
																		<li class = "txt_l phoneLi clearfix"><em>{vip}<a onclick = "registerZone2(this,1)" bossZone = "cxsjdp" href = "//wecar.qq.com/{sdealer_id}" target="_blank" autobussboss="dealer|onsale_price|6" >{sdealer_name}</a></em></li>\
																		{phone400}\
																	</ul>\
																</div>\
																</div>\
	        		...
	        		api:{
						IP_Url: '//fw.qq.com/ipaddress', //获取本地IP、城市
						dealer_IP_Url: window.TXCAR_infomation.host +'/api/askprice/getprovinceandcity', //获取本地IP、城市
						car_Brand_Url: '//js.data.auto.qq.com/car_public/1/manufacturer_list_json.js',//品牌
						car_Serial_Url: function(id){
							return '//js.data.auto.qq.com/car_manufacturer/'+id+'/serial_list_json.js';//车系
						},
						car_Model_Url: function(id){
							return '//js.data.auto.qq.com/car_serial/'+id+'/model_list.js';//车型
						},
						price_Model_Url: function(id){
	        				return window.TXCAR_infomation.host + '/api/askprice/getcarmodels/serial_id/'+id;//指定车系下车型
	        			},
						//serial_askPrice_submit_Url:'//crm.wecar.qq.com/api/activity/serialapply', //询底价提交
						serial_askPrice_submit_Url:'//wecar.qq.com/Api/activity/clueSignup',
						serial_province_Url: '//wecar.qq.com/dealer/inter/index/method/citys/type/1', //省份
						serial_citys_Url: function(id){
							return '//wecar.qq.com/dealer/inter/index/method/citys/type/2/pid/'+id;//城市
						},
						price_Order_Url:function(str){
							return '//wecar.qq.com/api/lowprice/priceList/?'+str;//条件查询普通模板接口
							
						},
						price_Order_Url_Serial:function(str){
							return '//wecar.qq.com/api/lowprice/priceListBySerial?'+str;								//条件查询车系分类模板接口
							//return '//wecar.qq.com/api/lowprice/priceList/?'+str;
						},
						dealer_List_Url:function(cityid){
							return '//wecar.qq.com/api/lowprice/recommDealerList?cityid='+cityid;
						}
	        		}
		        };
		        $.extend(true,op,_opt);
				...
				switch(api.type){
					...
					case 'json':
						self.crossAjax(url,function(ret){
							...
							if(ret.ret != 0){
								//异常上报
								var surl    = $('form input[name="source_url"]').val();
								var purl    = url;
								var channel = $('form input[name="type"]').val();
								self.abnormalBoss(2734,surl,purl,channel,ret.ret);
							}
			...
			setPostForm: function(dom){
				...
				oForm.submit(function(e){
					...
					if(!oErr.length && !status || !!DOM){
						...
						var url  = _act.indexOf('//') > -1 ? _act : op.pageInfo.host + _act;
						if(flag == '_self'){
							...
							//异常统计和提交统计
							var surl    = _this.find('input[name="source_url"]').val();
							var purl    = url;
							var channel = _this.find('input[name="type"]').val();
							var district = $($('.priceAsk')[0]).find('span').attr('autobussboss').split('|')[1];
							self.abnormalBoss('2586',surl,'submit','6',district);//提交统计
							self.crossAjax(url,function(oRet){
								if(oRet.code == 0){
									...
									self.abnormalBoss(2734,surl,purl,channel,oRet.code);//异常统计
							...
							function cityList(){
								...
								self.crossAjax(op.api.dealer_IP_Url,function(oRet){
									if(oRet.ret == 0 ){
										...
										//异常统计
										var surl    = _this.element.bd.find('input[name="source_url"]').val();
										var purl    = op.api.dealer_IP_Url;
										var channel = _this.element.bd.find('input[name="type"]').val();
										self.abnormalBoss(2734,surl,purl,channel,oRet.ret);
			...
			getPriceList:function(dom,urlObj){
				...
				function transferData(key,value){
					...
					value.phone400 = value.s400code && ((value.s400code.substr(0,3) == '400') ? '<li class = "txt_l phone400 clearfix"><em>电话:<span class = "phone">'+value.s400code+'</span></em></li>':'');
					...
					if(data.list != ''){
						...
						if(urlObj.type == "model"){
							...
							$.each(tableList,function(key,value){
								...
								if($.browser.ie6){
									$(this).parent().css('height',$(this).parent().height()-50);
									$(this).parent().find('.serialLeft').css('height',height+36);
								}
								else{
						...
						setpage(pages,page);
						$(document.body).append('<script type="text/javascript" src="//mat1.gtimg.com/auto/js/car2013/dealer_admin/registration.js?action=pop&type=pc_cutprice&w=480&bgcolor=ffffff&color=676767" charset="utf-8"></script>');
					}
					else{
						$("#serialList").empty();
						$("#list").empty();
			...
			queryOption:function(o){
				...
				var cityId = $("#cityId");
				var bid = !!self.getParam('brandid') ? self.getParam('brandid').replace(/[^0-9a-zA-Z]/g,"") : '';
				var sid = !!self.getParam('serialid') ? self.getParam('serialid').replace(/[^0-9a-zA-Z]/g,"") : '';
				var mid = !!self.getParam('modelid') ? self.getParam('modelid').replace(/[^0-9a-zA-Z]/g,"") : '';
				var cid = !!self.getParam('cityid') ? self.getParam('cityid').replace(/[^0-9a-zA-Z]/g,"") : '';
				var oid = !!self.getParam('order') ? self.getParam('order').replace(/[^0-9a-zA-Z]/g,"") : '';
					$.ajax({
						url:op.api.IP_Url,
						dataType: "script",
				...
				$.ajax({
					...
					success:function(){
						...
						$.each(dealerList,function(key,value){
							...
							phone = value.s400code && ((value.s400code.substr(0,3) == '400') ? '<p style="color:red;">'+value.s400code+'</p>' : '');
							result +='>'	
									+'<a autobussboss="dealer|onsale_dealer|6" target="_blank" href="//wecar.qq.com/'+value.sdealer_id+'"><img border="0" alt='+value.sdealer_name+' src="//img1.gtimg.com/datalib_img/'+ value.slogo+'"></a>'
									+'<p><a autobussboss="dealer|onsale_dealer|6" target="_blank" href="//wecar.qq.com/'+value.sdealer_id+'">'+value.sdealer_name+'</a></p>'
									+phone+'<a autobussboss="askprice|onsale_dealer|6" class="online_ask_btn" target="_blank" href="//wecar.qq.com/dealer/askpricedrive/index/id/'+value.sdealer_id+'?autobussboss=dealer|onsale_dealer|6&type=lowprice_dealer">在线咨询</a>'
									+'<em class="line"></em>'
									+'</li>';
						});
						$('.top').html(result);
			...
			abnormalBoss: function(bid,surl,purl,channel,info){
				//2734,页面url,接口url,渠道,返回信息
				//2586/2733,页面url,动作,页面ID,页面区域
				if(info == -999 || info == -998){
					return false;
				}
				bid == undefined && (bid='');
				surl == undefined && (surl='');
				...
				try{		
					var autoBossImg = new Image(1,1);
					var timestamp = Date.parse(new Date());
					var autourl = '//btrace.qq.com/kvcollect?ftime=&sIp=&iQQ='+iQQ+'&sBiz=dealerExposure&sOp='+purl+'&iSta=&iTy='+bid+'&iFlow='+timestamp+'&sRef=&sPageId='+channel+'&sPos='+info+'&sType=&sUrl='+surl;
...
//});
/*  |xGv00|0012a3b6da00be354805d231ff9ffe3c */