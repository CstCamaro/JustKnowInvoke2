	...
	(function(){
		...
		$.widget("ui."+projectName,{
			options:{
					...
					jsRoot: (/(lindan|q).qq.com/i.test(location.href)) ? 'js/' : '//mat1.gtimg.com/auto/js/car2013/',
					jspath: (/(lindan|q).qq.com/i.test(location.href)) ? 'js/' : '//mat1.gtimg.com/auto/js/car2013/cutprice/'+window.TXCAR_infomation.version+'/',
					jsask: (/(lindan|q).qq.com/i.test(location.href)) ? 'js/' : '//mat1.gtimg.com/auto/js/car2013/cutprice/20141028/',
			...
			Boss: function(a,b,c){
				...
				/*//btrace.qq.com/collect?sIp=&iQQ="+uin+"&sBiz=serial&sOp="+sOp+"&iSta=&iTy=1710&iFlow=&iValue=";*/
					win.g_btrace_boss[rnd].src="//btrace.qq.com/collect?sIp=&iQQ="+d+"&sBiz=serial&sOp="+a+"&iSta=&iTy="+b+"&iFlow=0&iValue=" + param+'&_='+this.getRandom();
				}catch(d){}
			},
			Qoss: function(_name){
			...
			init:function(){
				$.getScript(op.jsask+'price_v1.js',function(){
					self.initPrice();
				});
			}
    	});
...
});/*  |xGv00|e80657fd5325436c0fbc8d48bd65ad62 */