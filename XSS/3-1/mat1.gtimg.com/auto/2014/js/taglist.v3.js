//源自：http://tech.qq.com/dc_new/taglist.v3.js
    ...
    */
    ...
    ArticleList.prototype.fillData = function(itemObj,listHTML,i){
        ...
        switch (r)
        {
            ...
            return time;
            case 'imgarea':
            return itemObj.image?('<dt><a href="'+itemObj.url+'" target="_blank"><img onerror="this.src=\'http://mat1.gtimg.com/news/imgcss_article_qq/def_article_pic.jpg\'" src="'+itemObj.image+'" width="135" height="100" alt="'+title+'" /></a></dt>'):'';
            case 'tags':
...
}/*  |xGv00|6bc7b5f13911012e6bcaa665c96e9cae */