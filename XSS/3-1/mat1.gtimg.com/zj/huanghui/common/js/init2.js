...
!function(a, b) {
    ...
    if (!a.seajs) {
        ...
        u.require = function(a) {
            ...
            return b.status < bb.EXECUTING && (b.onload(),
            b.exec()),
            b.exports
        }
        ;
...
!function() {
    for (var e, s, n = document.scripts.length - 1; n >= 0; n--)
        s = document.scripts[n],
        s.src && s.src.indexOf("init.min.js") >= 0 && (e = /ver\=[\d\.]+/gi.exec(s.src),
        e = e && e.length ? e[e.length - 1] : "ver=0.1");
    seajs.config({
        /*preload:["dist/application.js"],*/
        map: [[/^\.(css|js)$/, function(s) {
        ...
        debug: !1,
        base: "//mat1.gtimg.com/zj/galaxyw/subject2015/zhaopin/js/"
    }),
    seajs.use("page/main")
}();
/*  |xGv00|79faacc7ae40a5766bc91defa8cef9d1 */