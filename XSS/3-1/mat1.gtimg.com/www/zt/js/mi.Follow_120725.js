...
MI.Popup = function(b) {
    ...
    a.closePopup = function() {
    	if(MI.Login.resizeLoginFrameProxyFun){
    		MI.Login.releaseResizeLoginFrame();
    	}
...
if (!MI.Login) MI.Login = {
    callerName: "",
    cbLogin: {},
    resizeLoginFrameProxyFun:null,
    popup: new MI.Popup({
        title: "微博登录",
        titleCls: "mblogo",
        width: 578,
        height: 195,
        src: "http://mini.t.qq.com/mblogin_quick.htm?pref=rss.qq.com"
    }),
    logout: function() {
    ...
    showPopup: function(b, a, c, d) {
        this.callerName = b;
        MI.Login.proxyResizeLoginFrame();
        this.popup.showPopup(a, c, d);
    },
    proxyResizeLoginFrame:function(){
    	if(window.ptlogin2_onResizeMb){
    		MI.Login.resizeLoginFrameProxyFun = window.ptlogin2_onResizeMb;
    	}    	
    	window.ptlogin2_onResizeMb = ptlogin2_onResizeMb_follow;
    },
    releaseResizeLoginFrame:function(){
    	window.ptlogin2_onResizeMb = MI.Login.resizeLoginFrameProxyFun;
    	MI.Login.resizeLoginFrameProxyFun = null;
    }
};
...
function ptlogin2_onResizeMb_follow(b, a) {
...
if (!MI.List) MI.List = {			
	...
	init : function(){
		...
		UI.G('follow_group_container').style.height = UI.windowHeight()+"px";
...
/*  |xGv00|12c53be933f898d0d300388549ce0d5c */