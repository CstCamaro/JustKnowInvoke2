...
function userLogin() {
    // 2018 6 13 修改登陆框
    // document.getElementById("login_frame").src = "http://ui.ptlogin2.qq.com/cgi-bin/login?hide_title_bar=0&low_login=0&qlogin_auto_login=1&no_verifyimg=1&link_target=blank&appid=636014201&target=top&s_url=http%3A//www.qq.com/qq2012/loginSuccess.htm";
  var qq_navWrap = document.getElementById("qq_navWrap");
  if (qq_navWrap) {
    // 2018 11 7 修改登录框 v_rruihan
    document.getElementById("login_frame").src = "https://graph.qq.com/oauth2.0/show?which=Login&display=pc&response_type=token&client_id=101502379&redirect_uri=http://page.coral.qq.com/coralpage/qqLoginCallback.html?rurl=" + window.location.href;
  } else {
    document.getElementById("login_frame").src = "http://xui.ptlogin2.qq.com/cgi-bin/xlogin?style=40&low_login=0&appid=636014201&target=self&s_url=http%3A//www.qq.com/qq2012/loginSuccess.htm";
  }
}
/*一键登录数据*/
function loginAll(obj){
    if(obj.result == 0){
        ...
        // 2017 12 05 注释掉了下面这一行 这一行会清除掉cookie 导致登陆失败
    ...
    if(document.getElementById('commentIframe')){
                ...
                document.getElementById('commentIframe').contentWindow.publicLogined(QQ.Cookie.get("uin"),userInfoName,userInfoFace);
    }

    //registerCoralEvent.publicLogined(QQ.Cookie.get("uin"),userInfoName,userInfoFace);
...
window["login"] = {
    ...
    loginOut:function(){
      QQ.Cookie.clear("skey", '/', "qq.com");
        ...
        QQ.Cookie.clear("qq_client_id", '/', "qq.com");
        QQ.Cookie.clear("qq_openid", '/', "qq.com");
        QQ.Cookie.clear("qq_access_token", '/', "qq.com");
...
//]]>/*  |xGv00|40a5dd54c6ec156ea8e2eed1e8d4e53d */