    ...
    */
    ...
    ArticleList.prototype.fillData = function(itemObj,listHTML,i){
        ...
        switch (r)
        {
            ...
            return time;
            case 'imgarea':
            return itemObj.image?(itemObj.image=TagSetting.isBigPic?itemObj.image.replace(/_small.jpg/g,".jpg"):itemObj.image,'<dt><a href="'+itemObj.url+'" target="_blank"><img onerror="this.src=\'http://mat1.gtimg.com/news/imgcss_article_qq/def_article_pic.jpg\'" src="'+itemObj.image+'" width="140" height="90" alt="'+title+'" /></a></dt>'):'';
            case 'tags':
...
}/*  |xGv00|0bcf75965e01205f87233f54fbe48db9 */