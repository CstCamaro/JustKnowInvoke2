var UA = function () {
    ...
    return {
        ...
        qqm: /mqqbrowser/.test(userAgent)  //手Q Browser
    };
};
...
function androidQQNewsShare () {
    if (UA().qqnews && UA().android) {
        var head = document.getElementsByTagName('body')[0];
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src = '//mat1.gtimg.com/www/js/newsapp/jsapi/news.js?_tsid=1';
        head.appendChild(script);
    }
}
/** 新闻客户端安卓分享：执行 */
androidQQNewsShare();/*  |xGv00|9b166e99e4ad57abce3659e870c75f30 */