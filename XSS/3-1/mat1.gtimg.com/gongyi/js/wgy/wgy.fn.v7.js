...
(function($) {     
	...
	*/
	...
	return this.bind('click',function(){
		//用户登陆判断
		if(global_userinfoobject.uin <= 0 || global_userinfoobject.global_gongyiuserinfo != 1)
		{
		//	$.cookie('loginBid',B);
			ptloginopenfun();
			return false;
			...
			function(response,status){
				if (typeof(rsObj) != "undefined" && rsObj != null && rsObj != "") {
					...
					if(rsObj.code==0 || typeof(rsShareObj) != "undefined" || (typeof(rsWeiaiObj) != "undefined" && rsWeiaiObj.code==0))
					{
						//hideDonateLayer();
						//成功
						var resMsg = '<div class="contentsss"><p>支持成功，感谢您的支持！</p><p>\"<span id="donateTipTitle"><a href="'+wgyData.url+'" target="_blank">'+wgyData.title+'</a></span></p><p>感谢您的热心参与，请关注该微爱梦想的进展。</p></div>';
					...
					var ERROR_NET_EX = "支持不成功，可能是网络问题引起，请您返回重试。";
					...
					switch(rsArr[2]){
						...
						default:errorMsg='支持不成功，可能是网络问题引起，请您返回重试。';
					}
					showAlerts('错误提示',errorMsg,1);
					rsObj = null;
					return false;
				}
				showAlerts('错误提示','支持不成功，可能是网络问题引起，请您返回重试。',1);
			}
		);
...
$.fn.wgy_donate.getLayer = function(wgyData,rsR){
 	...
 	<table border="0" cellpadding="0" cellspacing="0" style="margin:0 4px;" style="margin-top:10px;">\
		<tr><td colspan="2" style="padding:10px;"><div style="padding:5px;border:1px #CCC solid;color:#666;">本期微爱组织竞播已经于8月10日结束，您还可以继续支持公益组织，但当前的支持不会被计入对组织的有效投票。</a></td></tr>\
...
function getCookie_h(name)//取cookies函数        
{
	...
	/*  |xGv00|7bb1299a2f343a691febfb48e892e527 */