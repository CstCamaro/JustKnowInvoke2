 ...
 * Updated by suxiawang on 2017/11/30.
 */
...
(function(e, f) {
    ...
    for (var k =
        ...
        if (-1 < a[b].src.indexOf("search_children")) {
    ...
    window._Callback = function(a) {
        ...
        loadScript(_base + 'gy/404/data.js', function() {
			var d=jsondata.data;
			if(d && d.length){
...
! function() {
    ...
    e("body", function(a) {
        ...
        return d += '<div class="mod_404"> <div class="wrapper" id="mainWrap"> <div class="mod_hd"> <h1 class="title"><span class="title_inner">404\uff0c\u60a8\u8bbf\u95ee\u7684\u9875\u9762\u627e\u4e0d\u56de\u6765\u4e86\uff0c\u4f46\u6211\u4eec\u53ef\u4ee5\u4e00\u8d77\u5e2e\u4ed6\u4eec\u56de\u5bb6\uff01</span></h1> <div class="desc"><span class="desc_cd"><span id="J_countdown">7</span>秒后</span><a href="',
...
}();/*  |xGv00|63e083c8bafcaa7780af991df5071bdd */