...
var loginUI = {
  loginIn: function () {
    var htmlString = '<div class="quickArea user">\u4f60\u597d\uff0c<span id="nick">' + window.userInfo.nick + '</span> <a href="javascript:void(0);" target="_self" id="loginOut" bosszone="logquit" onclick="login.loginOut()">\u9000\u51fa</a></div><div class="quickArea menu"><a href="http://qzone.qq.com" id="qzoneLink" target="_blank" class="quickLink menu-hd qzoneLink" aria-expanded="true" bosszone="gqqzone"><em>Qzone</em></a></div><div class="quickArea menu"><a href="http://mail.qq.com" id="qmailLink" target="_blank" class="quickLink menu-hd qmailLink" aria-expanded="true" bosszone="gqqmail"><em>QQ\u90ae\u7bb1</em></a></div>';
    document.querySelector('#loginWrap').innerHTML = htmlString;
  },
  loginOut: function () {
    var htmlString = '<div class="quickArea"><a href="javascript:;" role="button" aria-haspopup="true" aria-pressed="false" id="oneKey" onclick="userLogin()" bosszone="gqonekey">\u4e00\u952e\u767b\u5f55</a></div><div class="quickArea menu"><a href="http://qzone.qq.com" id="qzoneLink" target="_blank" class="quickLink menu-hd qzoneLink" aria-expanded="true" bosszone="gqqzone"><em>Qzone</em></a></div><div class="quickArea menu"><a href="http://mail.qq.com" id="qmailLink" target="_blank" class="quickLink menu-hd qmailLink" aria-expanded="true" bosszone="gqqmail"><em>QQ\u90ae\u7bb1</em></a></div>';
    document.querySelector('#loginWrap').innerHTML = htmlString;
  }
}
...
var userLogin = window.userLogin = login.userLogin;/*  |xGv00|9d4c46a2200c7744b60a65439963b678 */