	...
	$.fn.KinSlideshow = function(settings) {
		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				...
				$(ksbs1).append("<a class='ctrl ctrl-L' href='javascript:;' target='_self'></a><a class='ctrl ctrl-R' href='javascript:;' target='_self'></a>");
				$(ksbs1 + " a.ctrl").css({
				...
				$(ksbs1 + " a.ctrl-L").hover(function(){
					$(this).css({'background-position':"-64px -440px",left:0})
				},function(){
					$(this).css({'background-position':"0 -440px",left:0})
				})
				$(ksbs1 + " a.ctrl-R").css({
					'background-position':"-136px -440px",
					right:0
				})
				$(ksbs1 + " a.ctrl-R").hover(function(){
					$(this).css({'background-position':"-199px -440px",right:0})
				},function(){
					$(this).css({'background-position':"-136px -440px",right:0})
				})
			};
		};
...
})(jQuery);/*  |xGv00|a4f3b257f23b563c6d81f58e02f90353 */