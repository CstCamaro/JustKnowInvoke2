...
(function($) {
    ...
    $.simpleSlider = {
        ...
        defaults: {
            ...
            useImageTitle: true,       // use the value of image-title attribute to display title
            ...
            nextText: '&nbsp',           // text showing on the next button
            title: true,                // show the image title
            previousText: '&nbsp;'        // text showing on the previous button
        }
    };
    /********************************************************************************/
    ...
    function SimpleSlider(element, options) {
        ...
        function initNavigation() {
            ...
            $(navigation).css({'width': options.width, 'height': '0px', 'z-index': options.zIndex + 110})
            ...
            $('#' + element.id + ', ' + getNavigation(true) + ', ' + getTitle(true)).mouseover(function () {
        ...
        function initBullets() {
            ...
            $(buttons).css({'z-index': options.zIndex + 121});
...
/*  |xGv00|ea480bad8cde0b3dc9470882b36cf943 */