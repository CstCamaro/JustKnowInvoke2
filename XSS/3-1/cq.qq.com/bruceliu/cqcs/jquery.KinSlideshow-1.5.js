		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				...
				$(ksbs + " a.ctrl-L").hover(function(){
					$(this).css({'background-position':"0 -118px",left:16})
				},function(){
					$(this).css({'background-position':"0 -49px",left:16})
				})
				$(ksbs + " a.ctrl-R").css({
				...
				$(ksbs + " a.ctrl-R").hover(function(){
					$(this).css({'background-position':"-37px -118px",right:16})
				},function(){
					$(this).css({'background-position':"-37px -49px",right:16})
				})
			};
		};
...
})(jQuery);/*  |xGv00|b3d1c8658ec87402470576aac8af0eda */