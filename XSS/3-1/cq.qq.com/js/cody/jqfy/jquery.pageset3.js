(function(){
	...
	function ShowPage(num){
		...
		$("#page_"+num+" li").css({padding:'3px','font-size':'14px'});
...
$(document).ready(function(){
	$("#PageSet").PageSet();
	$("#PageSet").css({'float':'left','padding':'0','margin':'0px'});
	$("#PageSet UL").css({'padding':'0px','margin':'0px','list-style-type':'none','padding-left':"20px"});
...
});/*  |xGv00|80b2aed9daa07d31247ba89489482989 */