	...
	$.fn.KinSlideshow = function(settings) {
		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				...
				$(ksbs + " a.ctrl-L").css({
					'background-position':"-353px -620px",
					left:16
				})
				$(ksbs + " a.ctrl-L").hover(function(){
					$(this).css({'background-position':"-353px -689px",left:16})
				},function(){
					$(this).css({'background-position':"-353px -620px",left:16})
				})
				$(ksbs + " a.ctrl-R").css({
					'background-position':"-389px -620px",
					right:16
				})
				$(ksbs + " a.ctrl-R").hover(function(){
					$(this).css({'background-position':"-389px -689px",right:16})
				},function(){
					$(this).css({'background-position':"-389px -620px",right:16})
				})
			};
		};
...
})(jQuery);/*  |xGv00|91d245f75e37155db9efbce1778d54ed */