...
**/
	...
	e = a.shareQQ = function(a) {
		_load("//joke.qq.com/qshare/iShare.css",
		function() {
			...
			function() {
				...
				function() {
					...
					KK("#iShare a").bind("click" ,function(){
						...
						var ff = _.share[""+this.name+""](iShare.title,iShare.url,iShare.imgUrl);
						//a.open(ff);
						...
						var classType = K("iShare").classNames();
							...
							var bosszone=new Image(1,1);bosszone.src="//btrace.qq.com/collect?sIp=&iQQ=&sBiz=iShare&sOp="+this.name+"&iStar=1&iTy=1547&iFlow=&iType="+classType+"&sUrl="+window.location.href+"&sRefer="+document.referrer+"&iRse3="+ishareUrl[0]+"";
					});
...
})(window, document);/*  |xGv00|dcfd9a1fc05b4574f64fcd965448d31b */