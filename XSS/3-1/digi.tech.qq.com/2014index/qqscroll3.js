...
(function($){
     ...
     * @param   {Object}    初始值
     */
    $.fn.qqScroll3 = function (options){

        var opts = $.extend({}, $.qqScroll3.defaults, options),
            obj = $(this),
            scroller = {};

            scroller.box = obj.find(opts.inner);
            scroller.list = scroller.box.find(opts.list);
            scroller.leftbox = scroller.box.find(opts.leftbox);
        ...
        scroller.fn = {
            ...
            init: function(){
	            var str = '<li class="split">' + scroller.items.eq(scroller.itemSum-1).html() + '</li>';
	            scroller.leftbox.show();
				scroller.leftbox.html(str);
...
})(jQuery);/*  |xGv00|365a9de47cf8e055be3fc5ee0bf2a032 */