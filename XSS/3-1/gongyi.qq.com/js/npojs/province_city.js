...
function Writepageinit(ObjectElementname,ProvinceValue,CityValue,RegionValue,SArray,returnflag){
	...
	if(SArray[ProvinceValue-1][3]==1){
		...
		//将直辖市的“省”转换为“市”
		if(SArray[ProvinceValue-1][2]==1)
		{
			if(returnflag==0) $("#"+ObjectElementname).html(Province+"市"+City+Region);
			else return Province+"市"+City+Region;
		}
		else
		{
...
/*  |xGv00|6f8e953263eda9eeef773ec1b3a68cbb */